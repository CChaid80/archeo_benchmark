#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""train_resnet18_desequilibre.py
...
Exemple :
  python train_resnet18_desequilibre.py \
    --train_dir ".../crops_imbalanced/train" \
    --val_dir   ".../crops_imbalanced/val" \
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--scenario", default="imbalanced")
